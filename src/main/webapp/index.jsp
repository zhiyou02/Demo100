...
<header>
    ...
    <div class="form_area">
        <div class="container">
            ...
            <!-- 报名表单，提交到apply -->
            <form id="iform" action="apply" enctype="multipart/form-data" method="post">
		...
		<li class="mt25">
			...
			<ul id="foo_icon">
				...
				<li class="erwei">
					<br>
					<div>
						<img class="weixin" src="img/a_002.png" alt="" draggable="false">
						<img class="weibo" src="img/a.png" alt="" draggable="false">
					</div>
				</li>
			</ul>
		</li>
