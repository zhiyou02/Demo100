...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal"  method="post" action="addCourse" >

			
			<div class="form-group">
			    <label for="subjectId" class="col-sm-2 control-label">所属学科</label>
			    <div class="col-sm-10">
					<select name="subject_name" id="subjectId" class="form-control">
						<option value="0" selected="selected">请选择所属学科</option>
						<c:forEach items="${list}" var="list">
							<option >${list.subject_name }</option>
						</c:forEach>
