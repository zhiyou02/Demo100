...
<link rel="icon" href="http://localhost:8080/videoimg/1.jsp" type="image/png">
...
<header>
	<div class="container">
		...
		<a target="_blank"><img src="../img/we.png" draggable="false">后台管理</a>
...
<div>
    <!--面包屑导航-->
    <div class="container mian-nav">公开课 /Python教程</div>
	...
	<div class="container">
		<div class="v-intro">
			...
			<div class="right">
				...
				<div class="avatar">
					<span style="background-image: url(http:localhost:8080/Job100/speakerimg/6.jpg)"></span>
	...
	<div class="container">
		<p class="title">目录</p>
			...
			<div class="chapter">
				...
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">433</span>
					<span class="duration"><img src="../img/player.png" alt="">562</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">365</span>
					<span class="duration"><img src="../img/player.png" alt="">596</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">332</span>
					<span class="duration"><img src="../img/player.png" alt="">1374</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">284</span>
					<span class="duration"><img src="../img/player.png" alt="">1692</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">266</span>
					<span class="duration"><img src="../img/player.png" alt="">1699</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">236</span>
					<span class="duration"><img src="../img/player.png" alt="">409</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">232</span>
					<span class="duration"><img src="../img/player.png" alt="">2112</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">206</span>
					<span class="duration"><img src="../img/player.png" alt="">1997</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">218</span>
					<span class="duration"><img src="../img/player.png" alt="">1569</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">223</span>
					<span class="duration"><img src="../img/player.png" alt="">2179</span>
				</div>
			</div>
			...
			<div class="chapter">
				...
				<p class="lecturer">讲师：赵桂丹</p>
				<div class="v-info">
					<span class="count"><img src="../img/count.png" alt="">244</span>
					<span class="duration"><img src="../img/player.png" alt="">2134</span>
				</div>
			</div>
		...
		<li class="mt25">
			...
			<ul id="foo_icon">
				...
				<li class="erwei">
					<br>
					<div>
						<img class="weixin" src="../img/a.png" alt="" draggable="false">
						<img class="weibo" src="../img/a_002.png" alt="" draggable="false">
					</div>
				</li>
			</ul>
		</li>
...
<div class="mask hidden" id="login">
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="loginForm" action="http://localhost:8080/Job100/#">
				<h3>快速登录</h3>
				...
				<div id="forget">
					<a href="http://localhost:8080/forgetPassword.action">忘记密码？</a>
				</div>
...
<div class="mask hidden" id="reg">
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="regForm" action="http://localhost:8080/Job100/user/insertUser.action">
				<h3>新用户注册</h3>
